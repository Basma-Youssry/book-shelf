		...
		return (
			<div className="app">
				<Route
					...
					render={({ history }) => (
						<Main
							selectedBookAndItsShelf={this.state.selectedBookAndItsShelf}
							changeShelfOfBook={this.changeShelfOfBook}
							mainSendBookSToSearch={this.mainSendBookSToSearch}
							history={history}
						/>
					)}
				/>
