...
class Main extends Component {
	...
	componentDidUpdate(prevProps) {
		if (
			prevProps.selectedBookAndItsShelf !== this.props.selectedBookAndItsShelf
		) {
			...
			if (selectedBook.shelf !== shelf) {
				if (shelf === "none") {
					const listOfBooksWithoutSelectedBook = this.state.bookShelves[
						selectedBook.shelf
					].filter(book => {
					...
					this.setState({
						bookShelves: {
							...
							[selectedBook.shelf]: listOfBooksWithoutSelectedBook,
						},
					});
				...
				if (selectedBook.shelf !== "none") {
					...
					this.setState({
						bookShelves: {
							...this.state.bookShelves,
							[tempShelf]: listOfBooksWithoutSelectedBook,
	...
	componentDidMount() {
		BooksAPI.getAll()
			.then(books => {
				...
				this.props.mainSendBookSToSearch(
							...
							<div>
								<div className="bookshelf">
									...
									<div className="bookshelf-books">
										<ListOfBooks
											changeShelfOfBook={this.props.changeShelfOfBook}
